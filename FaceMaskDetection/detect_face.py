...
if __name__ == '__main__':
    ...
    res = detectionmaskface(img, target_shape=(360, 360))
    print(res)
    pass
...
#     parser.add_argument('--img-path', type=str, default='img/nomask.jpg', help='path to your image.')
